...
export default function TechAssessmentHero(): React.JSX.Element {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#F7F5FF] px-4 py-16 sm:px-8 lg:px-16 flex items-center justify-center">
      <div 
        onMouseMove={handleMouseMove}
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={handleMouseLeave}
        className="group relative w-full max-w-6xl min-h-[440px] md:min-h-[400px] overflow-hidden rounded-[28px] border border-[#E4DDF5] bg-white p-8 shadow-[0_30px_95px_rgba(124,58,237,0.16)] backdrop-blur-sm md:p-12 lg:p-16 flex flex-col md:flex-row items-center justify-between gap-12"
      >
        ...
        <div className="flex-1 space-y-6 text-center md:text-left z-10 flex flex-col items-center md:items-start order-2 md:order-1">
          <div className="inline-flex items-center gap-2 rounded-full border border-violet-200 bg-violet-50 px-3 py-1.5 shadow-sm backdrop-blur-md">
            <Sparkles className="w-3.5 h-3.5 text-violet-600 animate-pulse" />
            <span className="text-[11px] font-bold uppercase tracking-[0.24em] text-violet-700 font-mono">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 leading-[1.15] tracking-tight max-w-xl">
            MASAR Tech <br />
            <span className="bg-gradient-to-r from-violet-700 to-teal-500 bg-clip-text text-transparent">
              Aptitude Indicator
            </span>
          </h2>
          ...
          <div className="pt-2 w-full sm:w-auto">
            <button 
              type="button"
              className="group/btn relative flex w-full items-center justify-center gap-2.5 rounded-2xl bg-violet-600 px-8 py-4 text-sm font-bold text-white shadow-[0_16px_35px_rgba(124,58,237,0.28)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-violet-700 hover:shadow-[0_20px_45px_rgba(124,58,237,0.36)] sm:w-auto active:scale-[0.98]"
            >
              Start Assessment
        ...
        <div className="flex-1 w-full flex items-center justify-center z-10 order-1 md:order-2 perspective-[1000px]">
          <motion.div
            ...
            className="relative flex w-full max-w-[340px] aspect-[1.1] flex-col justify-between rounded-[24px] border border-[#E4DDF5] bg-white/90 p-5 shadow-[0_26px_70px_rgba(15,23,42,0.14)] backdrop-blur-xl"
          >
            <div className="flex items-center justify-between border-b border-[#E4DDF5] pb-3">
            ...
            <div className="flex-grow flex flex-col justify-center gap-3.5 py-4">
              <div className="flex items-center justify-between rounded-xl border border-[#E4DDF5] bg-[#F7F5FF] p-3">
                <div className="flex items-center gap-2.5">
                  <div className="rounded-lg border border-violet-100 bg-violet-50 p-1.5 text-violet-600">
                    <Cpu className="w-4 h-4" />
                  </div>
                  <span className="text-xs font-semibold text-slate-800">System Aptitude</span>
                </div>
                <span className="text-[10px] font-mono font-bold text-violet-700">94.2%</span>
              </div>
